...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        UserFilesPath = "http://www.e-engr.info/files";  //it was here b4 
		...
		TypeConfig[ "Image" ].AllowedExtensions			= new string[] { "bmp", "gif", "jpeg", "jpg","pdf", "png" };
		...
		TypeConfig[ "Media" ].AllowedExtensions			= new string[] { "aiff", "asf", "avi", "bmp", "fla", "flv", "gif", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "png", "qt", "ram", "rm", "rmi", "rmvb", "swf", "tif", "pdf", "tiff", "wav", "wma", "wmv" };
