...
CodeFile="AdminACC_ChartOfAccountLabel4InsertUpdate.aspx.cs" Inherits="AdminACC_ChartOfAccountLabel4InsertUpdate" Title="ACC_ChartOfAccountLabel4 Insert/Update By Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="tableCss">
        <table>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblACC_HeadTypeID" runat="server" Text="ACC_HeadTypeID: ">
                    </asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblChartOfAccountLabel4Text" runat="server" Text="ChartOfAccountLabel4Text: ">
                    </asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtChartOfAccountLabel4Text" runat="server" Text="">
                    </asp:TextBox>
                </td>
            </tr>
            <tr>
