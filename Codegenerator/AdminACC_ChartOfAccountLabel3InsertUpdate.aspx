...
CodeFile="AdminACC_ChartOfAccountLabel3InsertUpdate.aspx.cs" Inherits="AdminACC_ChartOfAccountLabel3InsertUpdate" Title="ACC_ChartOfAccountLabel3 Insert/Update By Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="tableCss">
        <table>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblACC_ChartOfAccountLabel2ID" runat="server" Text="ACC_ChartOfAccountLabel2ID: ">
                    </asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblChartOfAccountLabel3Text" runat="server" Text="ChartOfAccountLabel3Text: ">
                    </asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtChartOfAccountLabel3Text" runat="server" Text="">
                    </asp:TextBox>
                </td>
            </tr>
            <tr>
