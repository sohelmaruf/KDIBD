...
public partial class Admin_Admin_DropDownList_Control_Value : System.Web.UI.Page
{
    ...
    private void Delete_Admin_DropDownList_Control_Value()
    {
        try
        {
            string sql=@"Delete [Admin_DropDownList_Control_Value] where Admin_DropDownList_Control_Value_ID = "+Request.QueryString["delete"];
    ...
    private void loadAllData()
    {
        ...
        order by [Admin_DropDownList_Control_Value].Admin_DropDownList_Control_Value_Name";
        DataSet ds = CommonManager.SQLExec_producteev(sql);
        string html = @"<table class='table table-striped table-bordered table-hover' id='dataTable'>
                ...
                <th>Admin DropDownList Control</th>
                <th>Admin DropDownList Control Value Name</th>
                <th>IsActive</th>
                                </tr>
                            </thead>
                            <tbody>";int count=0;
                            ...
                            <td>
                                        <div class='btn-group'>
                                            ...
                                            <ul class='dropdown-menu'>
                                                ...
                                                <li><a href='Admin_Admin_DropDownList_Control_Value.aspx?delete="+dr["Admin_DropDownList_Control_Value_ID"].ToString()+@"'  onclick="+"\"return confirm('Are you sure you want to edit?')\""+@">Delete</a></li>
                                            </ul>
                                        </div>
                                    </td>
