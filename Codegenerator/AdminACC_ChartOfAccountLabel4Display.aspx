<%@ Page Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true"
    CodeFile="AdminACC_ChartOfAccountLabel4Display.aspx.cs" Inherits="AdminACC_ChartOfAccountLabel4Display" Title="Display ACC_ChartOfAccountLabel4 By Admin" %>
    ...
    <div>
        ...
        <asp:GridView ID="gvACC_ChartOfAccountLabel4" runat="server" AutoGenerateColumns="false" CssClass="gridCss">
            <Columns>
                ...
                <asp:TemplateField HeaderText="ACC_HeadTypeID">
                    <ItemTemplate>
                        <asp:Label ID="lblACC_HeadTypeID" runat="server" Text='<%#Eval("ACC_HeadTypeID") %>'>
                        </asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="ChartOfAccountLabel4Text">
                    <ItemTemplate>
