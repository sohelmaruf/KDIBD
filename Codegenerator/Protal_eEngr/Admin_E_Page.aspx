<%@ Page Title="E Page" Language="C#" MasterPageFile="~/Login/AdminMaster.master" AutoEventWireup="true"
    CodeFile="Admin_E_Page.aspx.cs" Inherits="Admin_E_Page" %>
 ...
 <asp:HiddenField ID='hfLoginID' runat='server' />
    ...
    <div class="col-lg-6"><table><tr class='form-group'>
                ...
                <tr class='form-group'>
                                    ...
                                    <td class='col-lg-10'>
                    <asp:TextBox ID='txtLogo' runat='server' class='form-control' ></asp:TextBox>
                        </td>
                                </tr>
                <tr class='form-group'>
                                    <td class='control-label'>
                ...
                <tr class='form-group'>
                                    ...
                                    <td class='col-lg-10'>
                    <asp:DropDownList ID='ddlMem_MemberID' runat='server' class='chzn-select'>
                                            </asp:DropDownList>
                        </td>
                                </tr>
                </table>
