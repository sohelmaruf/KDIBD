<%@ Page Language="C#" MasterPageFile="~/Login/AdminMaster.master" AutoEventWireup="true"
    CodeFile="AdminACC_ChartOfAccountLabel3Display.aspx.cs" Inherits="AdminACC_ChartOfAccountLabel3Display" Title="Display ACC_ChartOfAccountLabel3 By Admin" %>
    ...
    <div>
        ...
        <asp:GridView ID="gvACC_ChartOfAccountLabel3" runat="server" AutoGenerateColumns="false" CssClass="gridCss">
            <Columns>
                ...
                <asp:TemplateField HeaderText="ACC_ChartOfAccountLabel2ID">
                    <ItemTemplate>
                        <asp:Label ID="lblACC_ChartOfAccountLabel2ID" runat="server" Text='<%#Eval("ACC_ChartOfAccountLabel2ID") %>'>
                        </asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="ChartOfAccountLabel3Text">
                    <ItemTemplate>
