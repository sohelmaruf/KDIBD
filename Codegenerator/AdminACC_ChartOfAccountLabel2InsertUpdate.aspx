...
CodeFile="AdminACC_ChartOfAccountLabel2InsertUpdate.aspx.cs" Inherits="AdminACC_ChartOfAccountLabel2InsertUpdate" Title="ACC_ChartOfAccountLabel2 Insert/Update By Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="tableCss">
        <table>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblACC_ChartOfAccountLabel1ID" runat="server" Text="ACC_ChartOfAccountLabel1ID: ">
                    </asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblChartOfAccountLabel2Text" runat="server" Text="ChartOfAccountLabel2Text: ">
                    </asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtChartOfAccountLabel2Text" runat="server" Text="">
                    </asp:TextBox>
                </td>
            </tr>
            <tr>
