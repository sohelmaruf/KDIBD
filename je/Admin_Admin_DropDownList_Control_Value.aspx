<%@ Page Title="Admin DropDownList Control Value" Language="C#" MasterPageFile="MasterPage2.master" AutoEventWireup="true"
 ...
 <asp:HiddenField ID='hfLoginID' runat='server' />
    ...
    Data on Each Drop down list</h1>
    </div>
    </div>
    <div class="row">
    <div class="col-lg-12">
    ...
    <div class="row">
        <div class='col-lg-6'> <table><tr class='form-group'>
                    ...
                    <td class='col-lg-10'>
                        <asp:DropDownList ID='ddlAdmin_DropDownList_Control_ID' runat='server' class='chzn-select form-group'>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr class='form-group'>
